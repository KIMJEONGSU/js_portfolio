...
- Google BigQuery와 Python 연동.
  - ```BigQuery 선택 이유``` : 필요에 따라 자동으로 확장되는 뛰어난 확장성과 데이터 분석가나 개발자들이 쉽게 접근하고 활용할 수 있는 간편한 사용성 때문에 선정. 
...
- 웹서버 구축과 페이지 구현
  * ```Flask 선택 이유``` : 필요한 기능을 선택적으로 확장하거나 추가할 수 있고 프로젝트의 크기와 요구 사항에 맞게 유연하게 사용할 수 있기 때문에 선정
  * Flask를 사용하여 웹서버 구축.
...
* 웹 배포
  ...
  * URL : [https://54.180.153.254:8080/](https://54.180.136.130:8080/)
